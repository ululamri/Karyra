          ...
          <div className="rounded-[2rem] border border-white/10 bg-white/5 p-6 md:p-8">
            ...
            <div className="mt-8 flex flex-col gap-3 sm:flex-row sm:flex-wrap">
              ...
              <Link
                 ...
                 className="inline-flex rounded-2xl border border-sky-400/30 bg-sky-400/10 px-6 py-4 text-base font-bold text-sky-300 transition hover:bg-sky-400/20 md:px-8 md:text-lg"
              >
                {language === "id" ? "Stellar Readiness" : "Stellar Readiness"}
              </Link>
            </div>
          </div>
