...
const approachPoints = [
  ...
  "Gunakan kursus, pelajaran, komunitas, dan Paspor Kesiapan sebagai alur bertahap.",
];
      ...
      <section className="mx-auto flex w-full max-w-5xl flex-col gap-8 px-4 py-6 pb-24 md:px-8 md:py-12">
        ...
        <section className="grid gap-4 lg:grid-cols-2">
          <article className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-5 md:p-6">
            ...
            <h2 className="mt-2 text-2xl font-black">Kebingungan dan ketakutan.</h2>
          ...
          <article className="rounded-[2rem] border border-emerald-400/20 bg-emerald-400/10 p-5 md:p-6">
            ...
            <h2 className="mt-2 text-2xl font-black">Non-teknikal dulu, teknikal kemudian.</h2>
            <div className="mt-5 grid gap-3">
        ...
        <section className="rounded-[2rem] border border-white/10 bg-white/[0.04] p-5 md:p-6">
          ...
          <Link
            ...
            className="mt-5 inline-flex min-h-11 items-center rounded-2xl bg-emerald-400 px-4 py-2.5 text-sm font-black text-slate-950"
          >
            Lanjut ke Kesiapan Grant
          </Link>
        </section>
      </section>
    </main>
