      ...
      <section className="mx-auto flex w-full max-w-6xl flex-col gap-8 px-4 py-6 pb-24 md:px-8 md:py-12">
        <header className="max-w-3xl">
          ...
          <p className="mt-4 text-sm leading-7 text-slate-300 md:text-base md:leading-8">
            Dokumentasi ini membantu menjaga narasi Karyra tetap jelas: mulai dari masalah salah paham tentang blockchain, jalur belajar, Paspor Kesiapan, sampai alur demo untuk reviewer.
          </p>
        </header>
